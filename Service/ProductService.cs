...
namespace historianproductionservice.Service
{
...

    {
        ...
        , IOrderService orderService)
        {
         ...
         private async Task<Product> AddInDB(Product product, InputData inputData,string ProductionOrderName)
         {
             ...
             if(order ==  null)
             {
                 ...
                 orderNew.productsInput = new List<Product>();
                 orderNew.productsOutput = new List<Product>();
         ...
         private Product CreateProduct(InputData inputData,string ProductName)
         {
